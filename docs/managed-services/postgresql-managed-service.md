...
|version|string|None|ورژن‌هایی که می‌توانید استفاده کنید:10.4, 9.5, 9.5.25, 9.6, 9, 11, 11.11, 12.6, 12, 13.2, 13 می‌باشد.|
:::tip راهنمایی
...
- ورژنی که برای ساخت PostgreSQL مشخص کردیم 10.4 می‌باشد
