module.exports = {
  someSidebar: {
    ...
    'managed-services/minio-managed-service', 'managed-services/rabbitmq-managed-service', 'managed-services/redis-managed-service',
    'managed-services/file-browser-managed-service', 'managed-services/proxy-managed-service', 'managed-services/memcached-managed-service'],
